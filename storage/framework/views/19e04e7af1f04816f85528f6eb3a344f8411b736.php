                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $__currentLoopData = $obats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td><?php echo e($obat->sediaan); ?></td>
                      <td><?php echo e($obat->dosis); ?> <?php echo e($obat->satuan); ?></td>
                      <td><?php echo e($obat->stok); ?></td>
                      <td><?php echo e(formatrupiah($obat->harga)); ?></td>
                      <td>
                        <a href ="<?php echo e(route('obat.edit', $obat->id)); ?>" class="btn btn-sm btn-icon-split btn-warning">
                            <span class="icon"><i class="fa fa-pen" style="padding-top: 4px;"></i></span><span class="text">Edit</span>
                        </a>
                        <a href="javascript:;" data-toggle="modal" onclick="deleteData(<?php echo e($obat->id); ?>)" data-target="#DeleteModal" class="btn btn-sm btn-icon-split btn-danger">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SKlinik\resources\views/obat.blade.php ENDPATH**/ ?>