...
<!--End Modal-->
    <div class="card shadow mb-4">
        <div class="card-header d-sm-flex align-items-center justify-content-between py-3">               
            ...
            <a href="<?php echo e(route('register')); ?>" class="d-none d-sm-inline-block btn btn-primary btn-sm shadow-sm">
                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td><?php echo e($user->profesi); ?></td>
                      <td><?php echo ($user->admin) === 1 ? '<span class="badge badge-success">' . ucwords(convert_boolean($user->admin)) .'</span>':'<span class="badge badge-danger">'. ucwords(convert_boolean($user->admin)) . '</span>'; ?></td>
                      <td>
                        <a href ="<?php echo e((Auth::user()->id === $user->id) ? route('profile.edit') : route('profile.edit.admin', $user->id)); ?>" class="btn btn-sm btn-icon-split btn-warning">
                            <span class="icon"><i class="fa fa-pen" style="padding-top: 4px;"></i></span><span class="text">Edit</span>
                        </a>
                        <a href="javascript:;" data-toggle="modal" onclick="deleteData(<?php echo e($user->id); ?>)" data-target="#DeleteModal" class="btn btn-sm btn-icon-split btn-danger">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SKlinik\resources\views/auth/users.blade.php ENDPATH**/ ?>