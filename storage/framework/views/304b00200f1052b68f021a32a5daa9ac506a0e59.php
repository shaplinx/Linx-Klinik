              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $__currentLoopData = $pasiens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pasien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td width="10%"><?php echo e(str_pad($pasien->id, 4, '0', STR_PAD_LEFT)); ?></td>
                      <td><?php echo e($pasien->nama); ?></td>
                      <td><?php echo e(hitung_usia($pasien->tgl_lhr)); ?></td>
                      <td><?php echo e($pasien->jk); ?></td>
                      <td class="text-truncate" style="max-width: 150px;"><?php echo e($pasien->alamat); ?></td>
                      <td><?php echo e($pasien->hp); ?></td>
                      <td>
                        <a href ="<?php echo e(route('rm.list', $pasien->id)); ?>" title="Buka RM" class="btn btn-circle btn-primary">
                            <i class="fas fa-file"></i>
                        </a>
                        <a href ="<?php echo e(route('pasien.edit', $pasien->id)); ?>" title="Edit" class="btn btn-circle btn-warning">
                            <i class="fas fa-pen"></i>
                        </a>
                        <a href="javascript:;" data-toggle="modal" onclick="deleteData(<?php echo e($pasien->id); ?>)" data-target="#DeleteModal" class="btn btn-circle btn-danger"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SKlinik\resources\views/pasien.blade.php ENDPATH**/ ?>